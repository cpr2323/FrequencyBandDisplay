...
SerialPortMenu::SerialPortMenu(String _componentName, String _label, ApplicationProperties* applicationProperties)
...
void SerialPortMenu::mouseEnter(const MouseEvent &event)
{
    setColour(textColourId, Colours::green);
}

void SerialPortMenu::mouseExit(const MouseEvent &event)
{
    setColour(textColourId, Colours::black);
}

void SerialPortMenu::mouseDown(const MouseEvent &event)
{
    PopupMenu menu;
